...
/**
 * Implementation of Bubble Sort algorithm for sorting drivers using custom data structures
 * This implementation doesn't use any Java collections
 */
public class CustomBubbleSortImplementation {
    
    /**
     * Sorts a custom list of drivers by their rating in descending order
     * @param drivers CustomDriverList of drivers to be sorted
     */
    public static void sort(CustomDriverList drivers) {
        sort(drivers, SortCriteria.RATING);
    }
    
    /**
     * Sorts a custom list of drivers by the specified criteria
     * @param drivers CustomDriverList of drivers to be sorted
     * @param criteria The criteria to sort by
     */
    public static void sort(CustomDriverList drivers, SortCriteria criteria) {
